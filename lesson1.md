...
- Для создания **жирного текста**, обрамляем двемя звездочками. 
- Для создания ~~зачеркнутого текста~~, необходимо обрамить двумя~. 
- _**Жирный курсив**_  создаем сочетанием вышеуказанных знаков.
___
...
> _! для этого нужно с новой строки нажимать отступ_
- список
    - подсписок
        - еще один подсписок
...
> _! если вам нужно использовать ссылку несколько раз. Вы,конечно, можете копировать и вставлять ее каждый раз. Но если вы захотите ее обновить или изменить, то придется находить ее каждый раз, когда она использовалась. Есть вариант получше: вы сможете найти по 'key' свою ссылку,изменить ее всего один раз._
...
Тот же метод, что и с изображением из интернета, только теперь на месте ссылки указываем URL адрес изображения.
Печатаем восклицательный знак, квадратные скобки, в которых указано название изображения круглые скобки, в них '/путь/к/изображению.расширение'


!в квадратных скобках 'Название изображения' в круглых скобках '/путь/к/изображению.расширение'

_Или_
```
<image src="/путь/к/изображению.расширение" alt="Название изображения">
```
